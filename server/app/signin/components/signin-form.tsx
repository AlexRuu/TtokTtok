                ...
                <FormItem>
                  ...
                  <FormLabel
                    ...
                    className={cn(
                      ...
                      "peer-placeholder-shown:top-0 peer-placeholder-shown:text-base cursor-text ease-in-out",
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormLabel
                    htmlFor="password"
                    className={cn(
                      "absolute text-sm left-3 top-2 transition-all duration-200 bg-transparent px-1",
                      "peer-placeholder-shown:top-0 peer-placeholder-shown:text-base cursor-text ease-in-out",
